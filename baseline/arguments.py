...
class Arguments:
    ...
    def add_common_args(self):
        ...
        self._parser.add_argument('--dim', type=int, default=4, help='')
        self._parser.add_argument('--beam', type=int, default=64, help='')
        ...
        ### others
        self._parser.add_argument('--FPD_path', type=str, default='', help='Statistics file path to evaluate FPD metric. (default:all_class)')
    ...
    def add_pretrain_args(self):
        ...
        ### ohters
        self._parser.add_argument('--ckpt_path', type=str, default='./', help='Checkpoint path.')
