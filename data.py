...
def load_dytost(dynamic, static,args):
    ...
    for i, j in zip(dynamic, static):
        dynamic_lidar = np.load(args.data + 'dynamic/' + str(i) + '.npy')
        static_lidar = np.load(args.data + 'static/' + str(i) + '.npy')
        ...
        dynamic_lidar = (dynamic_lidar).reshape(-1, 3, args.beam * int(1024/args.dim)) # 2048, 3, 40, 256 = > 20480, 3, 1024
        print(dynamic_lidar.shape)
        ...
        static_lidar = (static_lidar).reshape(-1, 3, args.beam * int(1024/args.dim)) # 2048, 3, 40, 256 = > 20480, 3, 1024  
        print(static_lidar.shape)
